...
try{
    ...
    String changedmno =request.getParameter("changedmno");
    //System.out.println("--");
    //System.out.println("1"+changename);
    //System.out.println("->"+session.getAttribute("custid"));
    stmt.executeUpdate("update  customer_account_details SET mobile_number  = '"+changedmno+"' where customerid='"+custid+"';");
    ...
    if(rs.next()){
        ...
        {%>
            ...
            confirm("change Mobile Number Successfull...Redirecting to Homepage");
