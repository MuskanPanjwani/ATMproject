...
try{
    ...
    stmt.executeUpdate("update customer_account_details SET account_type  = '"+changetype+"' where customerid='"+custid+"';");
    ...
    if(rs.next()){
        ...
        {%>
            ...
            confirm("changing Account Type Successfull...Redirecting to Homepage");
